...
$string['userprofilefieldsasurl'] = 'User profile fields as URL variables';
$string['userprofilefieldsasurl_desc'] = 'Should custom user profile fields be available as variables for URL parameters? Only for field types Checkbox, Date/time, Dropdown menu, Text input.';

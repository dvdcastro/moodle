...
$string['configuserprofilefields'] = 'Enable if you want to include user profile fields in list of available parameter variables.';
...
$string['groupnames'] = 'Group names (Separated by commas)';
...
$string['userfields'] = 'Custom user profile fields';
$string['userprofilefields'] = 'Include custom user profile fields';

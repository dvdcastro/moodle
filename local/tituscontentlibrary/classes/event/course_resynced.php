...
/**
 * Event fired after a Titus course re-sync completes successfully.
 *
 ...
 * }
 */
class course_resynced extends \core\event\base {
    ...
    public static function get_name(): string {
        return get_string('event:courseresynced', 'local_tituscontentlibrary');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' re-synced Titus content " .
            "'{$this->other['contentid']}' in the course with id '{$this->courseid}'.";
    }
     ...
     *
     * @param int $courseid Course the content belongs to.
     * @param string $contentid Titus source content id.
     * @param int $userid User who triggered the re-sync.
